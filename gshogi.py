...
class Game:
    ...
    def __init__(self):
        ...
        #if (sys.argv[1] != '-v' and sys.argv[1] != '-vusi' and sys.argv[1] !='run.py') and sys.argv[1] !="":
        ...
        print("Filename gelesen:  " + self.xname)
    ...
    def save_settings(self):
        ...
        s.lastdir = gv.gui.lastdir # last dir used
